...
kotlin {
    ...
    val xcf = XCFramework("Sqlx")

    macosArm64 {
        binaries.framework { baseName = "Sqlx"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Sqlx"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Sqlx"
        flattenPackage = "io.github.kotlinmania.sqlx"
    }

    android {
        namespace = "io.github.kotlinmania.sqlx"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "sqlx-kotlin", version.toString())

    pom {
        name.set("sqlx-kotlin")
        description.set("Kotlin Multiplatform port of launchbadge/sqlx - 🧰 The Rust SQL Toolkit. An async, pure Rust SQL crate featuring compile-time checked queries without a DSL. Supports PostgreSQL, MySQL, and SQLite")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/sqlx-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/sqlx-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/sqlx-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/sqlx-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSqlxXCFramework",
    "assembleSqlxDebugXCFramework",
    "assembleSqlxReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSqlxXCFramework",
    "assembleReleaseIosFatFrameworkForSqlxXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSqlxXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSqlxXCFramework",
    "assembleDebugMacosFatFrameworkForSqlxXCFramework",
    "assembleReleaseMacosFatFrameworkForSqlxXCFramework",
    "assembleDebugTvosFatFrameworkForSqlxXCFramework",
    "assembleReleaseTvosFatFrameworkForSqlxXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSqlxXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSqlxXCFramework",
    "assembleDebugWatchosFatFrameworkForSqlxXCFramework",
    "assembleReleaseWatchosFatFrameworkForSqlxXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSqlxXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSqlxXCFramework",
