# sqlx-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fsqlx--kotlin-blue.svg)](https://github.com/KotlinMania/sqlx-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/sqlx-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/sqlx-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/sqlx-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/sqlx-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`launchbadge/sqlx`](https://github.com/launchbadge/sqlx).

**Original Project:** This port is based on [`launchbadge/sqlx`](https://github.com/launchbadge/sqlx). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `launchbadge/sqlx`

> The text below is reproduced and lightly edited from [`https://github.com/launchbadge/sqlx`](https://github.com/launchbadge/sqlx). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
[sqlx-cli/README.md](https://github.com/launchbadge/sqlx/blob/HEAD/sqlx-cli/README.md#enable-building-in-offline-mode-with-query).
...
-   Apache License, Version 2.0
    ([LICENSE-APACHE](https://github.com/launchbadge/sqlx/blob/HEAD/LICENSE-APACHE) or http://www.apache.org/licenses/LICENSE-2.0)
-   MIT license
    ([LICENSE-MIT](https://github.com/launchbadge/sqlx/blob/HEAD/LICENSE-MIT) or http://opensource.org/licenses/MIT)
...
This Kotlin port is distributed under the same MIT license as the upstream [`launchbadge/sqlx`](https://github.com/launchbadge/sqlx). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the sqlx authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`launchbadge/sqlx`](https://github.com/launchbadge/sqlx) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
