...
This file is the quick-reference operating contract for sqlx-kotlin. The longer
...
sqlx-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`sqlx`](https://crates.io/crates/sqlx). Upstream Rust is the behavioral oracle while the
